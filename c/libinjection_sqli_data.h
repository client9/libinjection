...
static const keyword_t sql_keywords[] = {
    ...
    {"UCS2_ESTONIAN_CI", 't'},
    {"UCS2_GENERAL_CI", 't'},
    {"UCS2_GENERAL_MYSQL500_CI", 't'},
    {"UCS2_HUNGARIAN_CI", 't'},
    {"UCS2_ICELANDIC_CI", 't'},
    {"UCS2_LATVIAN_CI", 't'},
    {"UCS2_LITHUANIAN_CI", 't'},
    {"UCS2_PERSIAN_CI", 't'},
    {"UCS2_POLISH_CI", 't'},
    {"UCS2_ROMANIAN_CI", 't'},
    {"UCS2_ROMAN_CI", 't'},
    ...
    {"UTF16_CZECH_CI", 't'},
    {"UTF16_DANISH_CI", 't'},
    {"UTF16_ESPERANTO_CI", 't'},
    {"UTF16_ESTONIAN_CI", 't'},
    {"UTF16_GENERAL_CI", 't'},
    {"UTF16_GENERAL_MYSQL500_CI", 't'},
    {"UTF16_HUNGARIAN_CI", 't'},
    {"UTF16_ICELANDIC_CI", 't'},
    {"UTF16_LATVIAN_CI", 't'},
    {"UTF16_LITHUANIAN_CI", 't'},
    {"UTF16_PERSIAN_CI", 't'},
    {"UTF16_POLISH_CI", 't'},
    {"UTF16_ROMANIAN_CI", 't'},
    {"UTF16_ROMAN_CI", 't'},
    ...
    {"UTF32_CZECH_CI", 't'},
    {"UTF32_DANISH_CI", 't'},
    {"UTF32_ESPERANTO_CI", 't'},
    {"UTF32_ESTONIAN_CI", 't'},
    {"UTF32_GENERAL_CI", 't'},
    {"UTF32_GENERAL_MYSQL500_CI", 't'},
    {"UTF32_HUNGARIAN_CI", 't'},
    {"UTF32_ICELANDIC_CI", 't'},
    {"UTF32_LATVIAN_CI", 't'},
    {"UTF32_LITHUANIAN_CI", 't'},
    {"UTF32_PERSIAN_CI", 't'},
    {"UTF32_POLISH_CI", 't'},
    {"UTF32_ROMANIAN_CI", 't'},
    {"UTF32_ROMAN_CI", 't'},
    ...
    {"UTF8MB4_CZECH_CI", 't'},
    {"UTF8MB4_DANISH_CI", 't'},
    {"UTF8MB4_ESPERANTO_CI", 't'},
    {"UTF8MB4_ESTONIAN_CI", 't'},
    {"UTF8MB4_GENERAL_CI", 't'},
    {"UTF8MB4_GENERAL_MYSQL500_CI", 't'},
    {"UTF8MB4_HUNGARIAN_CI", 't'},
    {"UTF8MB4_ICELANDIC_CI", 't'},
    {"UTF8MB4_LATVIAN_CI", 't'},
    {"UTF8MB4_LITHUANIAN_CI", 't'},
    {"UTF8MB4_PERSIAN_CI", 't'},
    {"UTF8MB4_POLISH_CI", 't'},
    {"UTF8MB4_ROMANIAN_CI", 't'},
    {"UTF8MB4_ROMAN_CI", 't'},
    {"UTF8MB4_SINHALA_CI", 't'},
    {"UTF8MB4_SLOVAK_CI", 't'},
    {"UTF8MB4_SLOVENIAN_CI", 't'},
    {"UTF8MB4_SPANISH2_CI", 't'},
    {"UTF8MB4_SPANISH_CI", 't'},
    {"UTF8MB4_SWEDISH_CI", 't'},
    {"UTF8MB4_TURKISH_CI", 't'},
    {"UTF8MB4_UNICODE_CI", 't'},
    {"UTF8_BIN", 't'},
    {"UTF8_CZECH_CI", 't'},
    {"UTF8_DANISH_CI", 't'},
    {"UTF8_ESPERANTO_CI", 't'},
    {"UTF8_ESTONIAN_CI", 't'},
    {"UTF8_GENERAL_CI", 't'},
    {"UTF8_GENERAL_MYSQL500_CI", 't'},
    {"UTF8_HUNGARIAN_CI", 't'},
    {"UTF8_ICELANDIC_CI", 't'},
    {"UTF8_LATVIAN_CI", 't'},
    {"UTF8_LITHUANIAN_CI", 't'},
    {"UTF8_PERSIAN_CI", 't'},
    {"UTF8_POLISH_CI", 't'},
    {"UTF8_ROMANIAN_CI", 't'},
    {"UTF8_ROMAN_CI", 't'},
...
static const size_t sql_keywords_sz = 10253;
#endif
